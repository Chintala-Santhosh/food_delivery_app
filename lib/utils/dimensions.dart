...
class Dimensions{
  ...
  static double height45=screenHeight/16.88;

  static double width10=screenHeight/76;
  static double width15=screenHeight/50.6;
  static double width20=screenHeight/38;
  static double width30=screenHeight/25.3;

  static double fontSize16=screenHeight/47.5;
  static double fontSize14=screenHeight/54.2;
  static double fontSize20=screenHeight/38;
  static double fontSize26=screenHeight/29;

  static double iconSize24=screenHeight/31.3;
  static double iconSize16=screenHeight/47.3;

  static double radius10=screenHeight/76;
  static double radius15=screenHeight/50.6;
  static double  radius20=screenHeight/38;
  ...
  static double popularFoodImageSize=screenHeight/2.17;
  // static double listViewTextContainerSize=screenWidth/3.6;
